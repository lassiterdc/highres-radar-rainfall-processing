...
def return_d_filepaths():
    return f_nc_24h_atgages, f_nc_atgages, fldr_stageIV_data, f_csv_mrms_and_gage_events, f_csv_stageiv_and_gage_events, fldr_out_plots, f_shp_coast, f_shp_subcatchments, f_shp_gages

def return_worka_filepaths():
    return fld_mrms_hourly, f_stormcat_mrms_hrly_2003

def return_workb_filepaths():
    return f_nc_yearly, f_nc_yearly_stageIV
