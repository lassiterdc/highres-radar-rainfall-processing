...
f_out_nc_dailyavg = 'out_netcdfs/work_s_yearly_mm_per_day.nc'
f_out_nc_yearlyavg = 'out_netcdfs/work_s_yearly_totals.nc'
fl_out_zar = 'out_zarr/work_s_yearly.zarr'
fl_states = 'data/shapefiles/States_shapefile.shp'
fldr_plots_full = "plots/work_s_qaqc/full_dataset/{}.png"
fldr_plots_norfolk = "plots/work_s_qaqc/norfolk/{}.png"
fldr_plots_virginia = "plots/work_s_qaqc/norfolk/{}.png"
...
#%% plotting
ds_yearly = xr.open_dataset(f_out_nc_yearlyavg)
bm_time = time.time()
ds_yearly = ds_yearly.load()
print("Loaded netcdf into memory: {}".format(time.time() - bm_time))
######## plotting ###############
...
# plt.tight_layout()
plt.savefig(fldr_plots_full.format("all_years"), dpi=300)
...
ds_yearly_anomolies.plot.pcolormesh(x="longitude", y="latitude", col="time",
                                   ...
                                   cbar_kwargs={"label":"This scale is colored according to the 2nd and 98th percentiles."})
# plt.tight_layout()
plt.savefig(fldr_plots_full.format("all_years_anomolies_rel_to_avg_excluding_2012-2014"), dpi=300)
