...
if len(f_in_ncs_mrms) > 0:
    ...
    # mrms_rainonly = mrms.rainrate.reset_coords().rainrate
    # end dcl work
...
if extract_stage4_at_gages:
    ...
    print("Finished creating {} and {}. Time elapsed: {}".format(f_out_nc_mrms, f_out_csv_mrms, time.time()-start_time))
#%% performance
