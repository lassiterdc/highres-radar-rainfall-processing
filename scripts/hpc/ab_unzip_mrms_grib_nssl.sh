...
#SBATCH -o /project/quinnlab/dcl3nd/norfolk/scripts/script_out_ab/job.%j.%N.out	# Name of the output file (eg. myMPI.oJobID)
	...
	then
		...
		do
			...
			do
				...
				# Unzip the file only if the .grib file doesn't exist
