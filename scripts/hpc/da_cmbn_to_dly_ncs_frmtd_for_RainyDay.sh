...
#SBATCH -o /project/quinnlab/dcl3nd/norfolk/scripts/script_out_da/job.d1.%j.%N.out	# Name of the output file (eg. myMPI.oJobID)
...
do
 ...
 python scripts/_d1_cmbn_to_dly_ncs_frmtd_for_RainyDay.py  ${year}${month}${day} "/project/quinnlab/dcl3nd/norfolk/data/raw_data/mrms_grib_mesonet/" "/project/quinnlab/dcl3nd/norfolk/data/raw_data/mrms_grib_nssl/" "/project/quinnlab/dcl3nd/norfolk/data/raw_data/mrms_nc_quant/" "/project/quinnlab/dcl3nd/norfolk/data/_scratch_zarrs/" "/project/quinnlab/dcl3nd/norfolk/data/_scratch_gribs/" "/project/quinnlab/dcl3nd/norfolk/data/mrms_for_rainyday/"
done
